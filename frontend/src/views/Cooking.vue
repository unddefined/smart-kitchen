         ...
         <div class="flex w-full justify-between text-black gap-2">
            <button
               :class="[
                  ...
                  canStartDish || activeTab === 'overview'
                     ? ' text-black hover:bg-blue-600 bg-gray-300'
            ...
            <button
               :class="[
                  'py-1.5 border-none rounded-lg text-xl font-medium cursor-pointer transition-all duration-200 text-center flex-grow-[1.2] md:flex-grow-[1.1] sm:flex-grow-[1]',
                  canUrgentDish || activeTab === 'overview'
                     ? ' text-black hover:bg-red-600 bg-gray-300'
                     : 'bg-gray-300 text-gray-400 cursor-not-allowed',
               ]"
            ...
            <button
               :class="[
                  'py-1.5 border-none rounded-lg text-xl font-medium cursor-pointer transition-all duration-200 text-center flex-grow-[1.2] md:flex-grow-[1.1] sm:flex-grow-[1]',
                  canPauseDish || activeTab === 'overview'
                     ? ' text-black hover:bg-yellow-600 bg-gray-300'
                     : 'bg-gray-300 text-gray-400 cursor-not-allowed',
               ]"
            ...
            <div class="p-6">
               ...
               <div v-else-if="currentActionType === 'pause'" class="mb-4 p-3 bg-yellow-50 border-l-4 border-yellow-500 rounded">
                  <p class="text-base text-yellow-700">
                     <span class="font-semibold">暂停说明：</span>将订单状态恢复为"待起菜"，需要重新起菜才能继续出餐
                  </p>
               </div>
            ...
            <div class="px-6 py-4 border-t border-gray-200 flex gap-3 justify-end">
               ...
               <button
                  ...
                  :class="[
                     ...
                     !activeTab.startsWith('order-') && selectedOrderIds.length === 0
                        ? 'bg-gray-300 text-gray-400 cursor-not-allowed'
                        : actionButtonColor,
                  ]"
               >
