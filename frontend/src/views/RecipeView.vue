   ...
   <div class="recipe-view min-h-screen bg-gray-100">
      ...
      <div class="bg-white shadow-sm sticky top-0 z-10">
         <div class="flex items-center justify-between px-4 py-3">
            ...
            <button @click="editRecipe" class="px-4 py-2 bg-blue-500 text-white text-sm rounded-lg">编辑</button>
         </div>
      </div>
      ...
      <div class="p-4">
         ...
         <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="space-y-4">
               <div v-for="(step, index) in recipe.steps" :key="index" class="flex space-x-4">
                  ...
                  <div class="flex-1">
                     ...
                     <p v-if="step.time" class="text-sm text-gray-500 mt-1">预计时间: {{ step.time }}分钟</p>
                  </div>
               </div>
            </div>
         </div>
