      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="space-y-3">
          ...
          <div class="space-y-2 text-green-700">
            ...
            <div
              v-if="lastSubmission.data.orderId"
            ...
            <div
              v-if="lastSubmission.data.tableNumber"
              class="flex justify-between"
            >
            ...
            <div
              v-if="lastSubmission.data.hallNumber"
              class="flex justify-between"
            >
            ...
            <div
              v-if="lastSubmission.data.peopleCount"
              class="flex justify-between"
            >
        ...
        <div
          v-if="
            lastSubmission.data.dishes && lastSubmission.data.dishes.length > 0
          "
        >
...
const mockOrders = ref([
  ...
  },
  {
    ...
    peopleCount: 2,
    createdAt: new Date().toISOString(),
    items: [{ id: 3, name: "红烧肉", quantity: 1 }],
  },
]);
