            ...
            <div class="text-xl flex-1 overflow-y-auto p-4 space-y-4">
               ...
               <div class="flex space-x-4 items-start">
                  ...
                  <textarea
                     ...
                     class="text-xl w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
                  ></textarea>
               </div>
