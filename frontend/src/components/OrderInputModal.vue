<template>
  <Teleport to="#modal-container">
    ...
    <div
      v-if="visible"
      class="fixed inset-0 bg-black bg-opacity-50 flex items-end z-2000"
    >
      <div
        class="bg-white w-full rounded-t-2xl max-h-[90vh] flex flex-col min-h-[400px]"
      >
        <!-- 头部 -->
        ...
        <div class="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div class="flex space-x-4">
            <div class="flex items-center space-x-3 flex-1">
              <label class="text-xl text-gray-500 whitespace-nowrap"
                >人数</label
              >
              <input
          ...
          <div class="flex space-x-4 items-center">
            <label class="text-xl font-medium text-gray-700 whitespace-nowrap"
              >台号</label
            >
            <input
              v-model="hallNumber"
          ...
          <div>
            <div class="flex items-center justify-between mb-3">
              ...
              <button
                ...
                class="text-blue-500 hover:text-blue-700 text-xl font-medium"
              >
                + 新增菜品
              </button>
            </div>
            ...
            <!-- 无菜品提示 -->
            <div
              v-if="!dishesLoading && !dishesError && allDishes.length === 0"
    ...
    >
      <div class="bg-white rounded-xl w-full max-w-md">
        ...
        <div class="p-4 border-t bg-gray-50 flex space-x-3">
          <button
            @click="closeDishDetailModal"
            class="flex-1 py-3 bg-gray-200 text-black rounded-lg font-medium hover:bg-gray-300 transition-colors"
          >
            取消
          </button>
          <button
            @click="confirmDishEdit"
