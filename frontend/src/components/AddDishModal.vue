        ...
        <div v-if="selectedOrder" class="bg-blue-50 rounded-lg p-4">
          ...
          <div class="grid grid-cols-2 gap-2 text-xl">
            ...
            <div>
              ...
              <span class="ml-2 font-medium"
                >{{ selectedOrder.peopleCount }}人</span
              >
            </div>
            <div>
            ...
            <div>
              ...
              <div class="grid grid-cols-3 gap-2">
                ...
                >
                  {{ dish.name }}
                  <span
                    v-if="isOrderedSelected(dish.id)"
            ...
            <div>
              ...
              <div class="grid grid-cols-3 gap-2">
                ...
                >
                  {{ dish.name }}
                  <span
                    v-if="isAvailableSelected(dish.id)"
                    class="absolute -top-1 -right-1 w-5 h-5 bg-green-500 text-white text-xs rounded-full flex items-center justify-center"
                  >
...
const toggleAvailableDish = (dish) => {
  const index = availableSelectedDishes.value.findIndex(
    (d) => d.id === dish.id,
  );
  if (index >= 0) {
