<template>
  <div class="p-4 max-w-4xl mx-auto">
    ...
    <!-- 提交结果显示 -->
    <div v-if="submittedOrder" class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200 p-6 mb-8 shadow-sm">
        ...
        <div class="space-y-3">
          ...
          <div class="space-y-2 text-green-700">
            ...
            <div class="flex justify-between">
              ...
              <span>{{ submittedOrder.mealTime === 'lunch' ? '午餐' : '晚餐' }}</span>
            </div>
            <div class="flex justify-between">
        ...
        <div>
          ...
          <div class="space-y-2">
            ...
            >
              ...
              <div class="text-green-700 font-medium">× {{ dish.quantity }}</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- 功能特性说明 -->
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200 p-6 shadow-sm">
      <h2 class="text-xl font-bold text-blue-800 mb-4">核心功能特性</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div v-for="feature in features" :key="feature.title" class="bg-white rounded-lg p-4 border border-blue-100">
          <div class="flex items-center mb-3">
            <div class="w-8 h-8 rounded-full flex items-center justify-center mr-3" :class="feature.bgColor">
